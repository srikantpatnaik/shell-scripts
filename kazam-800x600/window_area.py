...
class AreaWindow(GObject.GObject):
    ...
    def __init__(self):
        ...
        # Position and size (original, see the modified below)
        #self.startx = 0
        #self.starty = 0
        #self.endx = 0
        #self.endy = 0
